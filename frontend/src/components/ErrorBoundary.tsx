      ...
      return (
        <div className="min-h-screen flex items-center justify-center p-8 bg-[#F8F7F2]">
          <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-xl border border-red-100 text-center">
            ...
            <h1 className="text-xl font-bold text-navy mb-2">Ops! Algo deu errado</h1>
            <p className="text-slate-500 text-sm mb-6">
              Ocorreu um erro inesperado nesta parte da aplicação. Nossa equipe técnica já foi notificada.
            </p>
            <button
              onClick={() => window.location.reload()}
              className="bg-slate-50 text-navy px-6 py-3 rounded-xl font-bold hover:bg-black transition-all"
            >
