                ...
                return (
                  <button type="button" key={p.id} onClick={() => togglePlatform(p.id)}
                    ...
                    <div className="text-left">
                      <p className={`text-xs font-black ${selected ? `text-${p.color}-300` : 'text-slate-400'}`}>{p.label}</p>
            ...
            {isLoading ? (
              <div className="flex-1 flex items-center justify-center">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-sm text-slate-400 font-bold">Criando posts personalizados...</p>
              ...
              <div className="flex-1 flex flex-col items-center justify-center text-center opacity-30 space-y-4">
                ...
                <div>
                  <p className="text-slate-400 text-sm font-black uppercase tracking-widest">Seus posts aparecerão aqui</p>
