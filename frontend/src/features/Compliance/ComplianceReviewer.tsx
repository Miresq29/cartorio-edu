    ...
    <div className="p-8 max-w-[1600px] mx-auto space-y-8 pb-32 animate-in fade-in duration-700">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 no-print">
        <div className="lg:col-span-5 space-y-6">
          <div className="bg-[#F5F4EF] border border-slate-200 rounded-[32px] p-8 space-y-7 shadow-2xl">
              ...
              <div className="space-y-3">
                ...
                {checklists.length === 0 ? (
                  ...
                  <select
                    ...
                    className="w-full bg-[#F5F4EF] border border-slate-200 rounded-xl px-4 py-4 text-xs font-bold text-slate-800 focus:border-blue-600 outline-none transition-all"
                  >
