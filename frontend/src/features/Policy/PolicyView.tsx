        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              ...
              <div key={i} className="bg-[#F8F7F2] border border-slate-200 rounded-xl p-3 text-center space-y-2">
                <i className={`fa-solid ${item.icon} text-${item.color}-400`}></i>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            {[
              ...
              <div key={i} className="flex items-start gap-3 p-3 bg-[#F8F7F2] border border-slate-200 rounded-xl">
