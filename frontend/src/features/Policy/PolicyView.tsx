...
const PolicyView: React.FC = () => {
  return (
    <div className="p-12 max-w-5xl mx-auto space-y-10 animate-in fade-in duration-700 pb-20">
      ...
      <div className="bg-[#F5F4EF] border border-slate-200 rounded-[40px] p-12 space-y-10 shadow-2xl">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              ...
              <div key={i} className="bg-[#F5F4EF] border border-slate-200 rounded-xl p-3 text-center space-y-2">
                <i className={`fa-solid ${item.icon} text-${item.color}-400`}></i>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            {[
              ...
              <div key={i} className="flex items-start gap-3 p-3 bg-[#F5F4EF] border border-slate-200 rounded-xl">
