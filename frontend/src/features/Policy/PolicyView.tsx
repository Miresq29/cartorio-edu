  ...
  return (
    <div className="p-12 max-w-5xl mx-auto space-y-10 animate-in fade-in duration-700 pb-20">
      ...
      <div className="bg-[#0a0f1d] border border-slate-800 rounded-[40px] p-12 space-y-10 shadow-2xl">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              ...
              <div key={i} className="bg-[#05080f] border border-slate-800 rounded-xl p-3 text-center space-y-2">
                <i className={`fa-solid ${item.icon} text-${item.color}-400`}></i>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            {[
              ...
              <div key={i} className="flex items-start gap-3 p-3 bg-[#05080f] border border-slate-800 rounded-xl">
        ...
        <div className="bg-slate-900/50 border border-slate-800 rounded-3xl p-8 flex items-start gap-4">
          <i className="fa-solid fa-circle-info text-slate-400 text-xl mt-1 flex-shrink-0"></i>
          <div>
