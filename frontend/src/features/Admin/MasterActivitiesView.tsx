        ...
        <form onSubmit={handleCreateTemplate} className="bg-white border border-slate-200 rounded-[40px] p-12 space-y-6 shadow-2xl">
          ...
          <div className="space-y-4">
            ...
            <input 
              ...
              className="w-full bg-[#0D1B3E] border border-slate-200 rounded-3xl p-5 text-[#0A1628] outline-none focus:border-emerald-600 transition-all font-bold" required 
            />
          </div>
