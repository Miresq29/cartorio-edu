        ...
        <form onSubmit={handleCreateTemplate} className="bg-white border border-slate-200 rounded-[40px] p-12 space-y-6 shadow-2xl">
          ...
          <div className="space-y-4">
            ...
            <input 
              ...
              className="w-full bg-white border border-slate-200 rounded-3xl p-5 text-[#0A1628] outline-none focus:border-emerald-600 transition-all font-bold" required 
            />
          </div>
        ...
        <div className="bg-white border border-slate-200 rounded-[40px] p-10 space-y-6 shadow-lg">
          ...
          <div className="space-y-3 max-h-[400px] overflow-y-auto custom-scrollbar pr-2">
            ...
            {allTemplates.map((ct: any) => (
              <div key={ct.id} className="p-5 bg-white border border-slate-200 rounded-2xl flex items-center gap-4 group hover:border-emerald-500/30 transition-all">
