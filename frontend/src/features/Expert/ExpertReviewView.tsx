      ...
      <div className="bg-[#0a0f1d] rounded-[48px] border border-slate-800 shadow-4xl overflow-hidden relative group">
        ...
        <div className="p-12 space-y-10 relative z-10">
          <div className="flex items-center gap-4">
            ...
            <h3 className="text-lg font-black text-slate-400 uppercase tracking-[0.4em]">Submissão de Caso Técnico</h3>
          </div>
          
          <textarea 
            value={query}
            onChange={(e) => setQuery(e.target.value)}
            className="w-full h-80 bg-slate-950 border border-slate-800 rounded-[32px] p-10 focus:ring-4 focus:ring-blue-600/10 focus:border-blue-600 focus:outline-none transition-all text-slate-300 leading-loose font-serif text-xl placeholder:text-slate-700"
