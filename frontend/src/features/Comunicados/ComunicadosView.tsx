                  ...
                  <div className="flex gap-2 pt-1">
                    ...
                    {isGestor && modo === 'gestao' && (
                      <button onClick={() => arquivar(c.id)}
                        className="text-[9px] bg-slate-800 hover:bg-red-500/20 text-slate-400 hover:text-red-400 px-4 py-2 rounded-xl font-black uppercase tracking-widest transition-all">
