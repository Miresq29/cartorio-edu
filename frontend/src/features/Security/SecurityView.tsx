    ...
    <div className="p-8 min-h-full bg-slate-50 text-slate-700">
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <header className="flex items-center gap-8">
          ...
          <div>
            <h2 className="text-5xl font-black tracking-tight mb-3 text-[#0D1B3E]">Seguranca e Manutencao</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 bg-white border border-slate-200 rounded-[40px] p-12 flex flex-col space-y-12 transition-all hover:border-slate-700 shadow-2xl relative overflow-hidden">
            ...
            <div>
              ...
              <p className="text-slate-500 text-lg max-w-xl leading-relaxed">Realize backups periodicos para garantir a conformidade com as normas de custodia de dados do cartório.</p>
            </div>
