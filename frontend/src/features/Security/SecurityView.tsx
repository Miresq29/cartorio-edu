      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 bg-white border border-slate-200 rounded-[40px] p-12 flex flex-col space-y-12 transition-all hover:border-slate-700 shadow-2xl relative overflow-hidden">
            ...
            <div>
              ...
              <p className="text-slate-500 text-lg max-w-xl leading-relaxed">Realize backups periodicos para garantir a conformidade com as normas de custodia de dados do cartÃ³rio.</p>
            </div>
        ...
        <div className="bg-white border border-slate-200 rounded-[24px] p-8 space-y-8 shadow-sm">
           <div className="flex items-center gap-5">
             ...
             <h3 className="text-lg font-black uppercase tracking-[0.3em] text-slate-500">PolÃ­ticas Ativas de SeguranÃ§a</h3>
           </div>
