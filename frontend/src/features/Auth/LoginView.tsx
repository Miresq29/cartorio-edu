  ...
  return (
    <div className="min-h-screen bg-[#0D1B3E] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-[440px] z-10">
        <div className="bg-[#1A2A52] border border-[#C9A84C]/30 rounded-[40px] p-10 shadow-2xl backdrop-blur-sm">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-black text-white italic uppercase tracking-tighter">
              MJ <span className="text-blue-500">Consultoria</span>
            </h1>
            <p className="text-slate-400 text-[10px] font-bold uppercase tracking-[0.3em] mt-2">Plataforma de Treinamento Corporativo</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-[#0D1B3E] border border-[#C9A84C]/30 rounded-2xl p-4 pl-12 text-white outline-none focus:border-blue-600 focus:ring-1 focus:ring-blue-600 transition-all placeholder:text-slate-200"
                value={email}
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Senha"
                className="w-full bg-[#0D1B3E] border border-[#C9A84C]/30 rounded-2xl p-4 pl-12 pr-12 text-white outline-none focus:border-blue-600 focus:ring-1 focus:ring-blue-600 transition-all placeholder:text-slate-200"
                value={password}
        ...
        <p className="text-center mt-8 text-slate-300 text-[10px] uppercase tracking-widest">
