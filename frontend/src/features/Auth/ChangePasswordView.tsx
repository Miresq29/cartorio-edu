...
const ChangePasswordView: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#05080f] flex items-center justify-center p-4">
      <div className="bg-[#0a0f1d] w-full max-w-md rounded-[40px] shadow-2xl p-12 border border-blue-500/20 space-y-8">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-[#05080f] border border-slate-800 rounded-2xl p-4 text-xs font-bold text-slate-200 focus:border-blue-500 outline-none pr-12"
                placeholder="••••••••••••"
                required
              />
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                className={`w-full bg-[#05080f] border rounded-2xl p-4 text-xs font-bold text-slate-200 focus:border-blue-500 outline-none pr-12 ${confirmPass && confirmPass !== newPass ? 'border-red-500/50' : 'border-slate-800'}`}
                placeholder="••••••••••••"
                required
              />
