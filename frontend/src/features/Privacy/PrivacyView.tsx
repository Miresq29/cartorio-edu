        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            {[
              ...
              <div key={i} className="flex items-start gap-4 p-4 bg-[#F5F4EF] border border-slate-200 rounded-xl">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              ...
              <div key={i} className="bg-[#F5F4EF] border border-slate-200 rounded-xl p-4 space-y-2 text-center">
