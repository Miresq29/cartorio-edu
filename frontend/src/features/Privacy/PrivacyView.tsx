    ...
    <div className="p-12 max-w-5xl mx-auto space-y-10 animate-in fade-in duration-700 pb-20">
      <header className="space-y-4">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <span className="text-[9px] font-black bg-slate-700/50 text-[#8A9BB0] border border-[#D4C5A0] px-3 py-1.5 rounded-lg uppercase tracking-widest">Última atualização: Fev/2026</span>
        </div>
      </header>

      <div className="bg-[#FBF7EE] border border-[#E8D5A3] rounded-[40px] p-12 space-y-10 shadow-2xl">
        ...
        <div className="space-y-4">
          ...
          <p className="text-[#1A2744] text-sm leading-loose text-justify">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            {[
              ...
              <div key={i} className="flex items-start gap-4 p-4 bg-[#FBF7EE] border border-[#E8D5A3] rounded-xl">
                <span className="text-[10px] font-black text-[#2C3E5A] bg-slate-900 border border-[#E8D5A3] px-2 py-1 rounded-lg flex-shrink-0">{item.num}</span>
                <p className="text-xs text-[#1A2744] leading-relaxed">{item.text}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <p className="text-[#1A2744] text-sm leading-loose">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              ...
              <div key={i} className="bg-[#FBF7EE] border border-[#E8D5A3] rounded-xl p-4 space-y-2 text-center">
                ...
                <p className="text-[9px] text-[#5A6E8A] leading-relaxed">{item.desc}</p>
              </div>
            ))}
          </div>
          <div className="bg-slate-900/50 border border-[#E8D5A3] rounded-xl p-4">
            <p className="text-xs text-[#5A6E8A] italic">
              <i className="fa-solid fa-circle-info text-[#2C3E5A] mr-2"></i>
              Como o tratamento tem base em <strong className="text-[#8A9BB0]">execução de contrato</strong> (Art. 7º, V — LGPD), não se aplica o direito de revogação de consentimento nem portabilidade de dados, pois o uso da plataforma é determinado pela própria serventia no exercício de suas atividades.
            </p>
          </div>
          <p className="text-xs text-[#5A6E8A] italic">Para exercer seus direitos, entre em contato via módulo de Suporte Técnico.</p>
        </div>
        ...
        <div className="bg-blue-500/5 border border-blue-500/20 rounded-3xl p-8 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-[9px] text-[#2C3E5A] mt-3">
