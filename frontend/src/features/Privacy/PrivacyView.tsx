    ...
    <div className="p-12 max-w-5xl mx-auto space-y-10 animate-in fade-in duration-700 pb-20">
      <header className="space-y-4">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <span className="text-[9px] font-black bg-slate-700/50 text-slate-500 border border-slate-200 px-3 py-1.5 rounded-lg uppercase tracking-widest">Última atualização: Fev/2026</span>
        </div>
      </header>

      <div className="bg-[#F8F7F2] border border-slate-200 rounded-[40px] p-12 space-y-10 shadow-2xl">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            {[
              ...
              <div key={i} className="flex items-start gap-4 p-4 bg-[#F8F7F2] border border-slate-200 rounded-xl">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              ...
              <div key={i} className="bg-[#F8F7F2] border border-slate-200 rounded-xl p-4 space-y-2 text-center">
