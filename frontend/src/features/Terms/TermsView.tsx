  ...
  return (
    <div className="p-12 max-w-5xl mx-auto space-y-10 animate-in fade-in duration-700 pb-20">
      <header className="space-y-4">
        <div className="w-16 h-16 bg-slate-800 rounded-3xl flex items-center justify-center text-slate-400 border border-slate-700 shadow-xl">
      ...
      <div className="bg-[#0a0f1d] border border-slate-800 rounded-[40px] p-12 space-y-10 shadow-2xl">
        ...
        <div className="space-y-4">
          ...
          <p className="text-slate-300 text-base leading-loose text-justify">
