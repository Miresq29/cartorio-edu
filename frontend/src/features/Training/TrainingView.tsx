...
`;
  ...
  const renderIATab = () => (
    <div className="space-y-4">
      ...
      <div className="bg-[#F8F7F2] border border-slate-200 rounded-2xl p-4">
      ...
      {(checklists.length > 0 || knowledgeDocs.length > 0) && (
        <div className="bg-[#F8F7F2] border border-slate-200 rounded-2xl p-4 space-y-2">
            ...
            {trainingOptions.map((opt, i) => {
              ...
              return (
                <button key={i} onClick={() => selectOption(opt)}
                  className={`text-left bg-[#F8F7F2] border border-${color}-500/30 hover:border-${color}-500 rounded-2xl p-5 space-y-3 transition-all hover:bg-${color}-500/5 group`}>
      ...
      {/* Chat de resultado */}
      <div className="bg-[#F8F7F2] border border-slate-200 rounded-2xl overflow-hidden">
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#F8F7F2] border border-slate-200 rounded-2xl p-4 space-y-3">
        ...
        <div className="bg-[#F8F7F2] border border-slate-200 rounded-2xl p-5 min-h-[350px] flex flex-col">
