...
import {
  collection, onSnapshot, query, orderBy, where, where,
          ...
          <div className="space-y-2">
            {questao.opcoes.map((opcao, i) => (
              <button key={i} onClick={() => handleAnswer(i)}
                className="w-full text-left p-4 rounded-xl bg-slate-50 border border-slate-200 hover:border-blue-500 hover:bg-blue-500/10 text-slate-700 text-sm transition-all">
