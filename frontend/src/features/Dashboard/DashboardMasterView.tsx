...
const DashboardMasterView: React.FC = () => {
  ...
  return (
    <div className="p-10 space-y-10 bg-[#F5F4EF] min-h-screen animate-in fade-in">
      <header>
      ...
      <div className="bg-white border border-slate-200 rounded-[40px] p-8 shadow-2xl relative overflow-hidden">
        ...
        <div className="space-y-4 relative z-10">
          {tenants.map((t: any) => (
            <div key={t.id} className="p-5 bg-[#F5F4EF] border border-slate-200 rounded-2xl flex justify-between items-center group hover:bg-slate-900 transition-all">
