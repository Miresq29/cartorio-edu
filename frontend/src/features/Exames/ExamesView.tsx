...
const ExamesView: React.FC = () => {
  ...
  if (fase === 'gerando') {
    return (
      <div className="p-8 min-h-screen bg-[#F8F7F2] flex flex-col items-center justify-center gap-6">
  ...
  if (fase === 'fazendo') {
    return (
      <div className="p-6 md:p-8 min-h-screen bg-[#F8F7F2] space-y-6 animate-in fade-in">
        {/* cabeçalho */}
  ...
  if (fase === 'resultado' && resultado) {
    ...
    return (
      <div className="p-8 min-h-screen bg-[#F8F7F2] flex flex-col items-center justify-center gap-6 animate-in fade-in">
        {/* badge principal */}
